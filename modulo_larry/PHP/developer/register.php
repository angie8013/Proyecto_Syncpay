...
//conectar bd
require_once("../../../modulo_angie/db/conection.php");
$db = new Database();
$con = $db->conectar();
session_start();
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "regm")) {
  ...
  if ($id_us == "" || $nombre_us == "" || $apellido_us == "" || $correo_us == "" || $tel_us == "" ||  $pass == "" || $id_rol == "" || $Codigo == "") {
    ...
    $insertSQL = $con->prepare("INSERT INTO usuarios (id_us,nombre_us,apellido_us,correo_us,tel_us,pass,id_rol,Codigo) VALUES ('$id_us','$nombre_us', '$apellido_us','$correo_us','$tel_us','$pass','$id_rol', '$Codigo')");
    $insertSQL->execute();
        ...
        <form action="#" name="form" method="post">
          ...
          <div class="row">
            <div class="form-group col-md-4">
              <label>* Cedula</label>
              <input type="numb"  title="Solo se permiten números con un máximo de 10 dígitos" class="form-control border border-dark mb-3" name="id_us" placeholder="Cedula del usuario" required>
            </div>
            <div class="form-group col-md-4">
              <label>Nombre</label>
            ...
            <div class="form-group col-md-3">
              ...
              <input type="numb"  title="Debe ser un número de 10 dígitos" class="form-control border border-dark mb-3" name="Codigo" placeholder="" required>
            </div>
      ...
      <table class="table table-dark mn-auto">
        ...
        <table class="table table-light">
          ...
          <form autocomplete="off" name="frm_consulta" method="GET">
            ...
            <?php
            $sql1 = $con->prepare("SELECT * FROM usuarios, roles WHERE  roles.ID = 4  AND usuarios.id_rol = roles.ID ORDER BY id_us ASC");
            $sql1->execute();
